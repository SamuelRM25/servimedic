...
$sql = "
    ...
    WHERE DATE(e.fecha_examen) BETWEEN ? AND ?
";

$params = [$fecha_inicio, $fecha_fin];

if ($tipo_paciente) {
    $sql .= " AND e.tipo_paciente = ?";
...
$sql .= " ORDER BY e.fecha_examen DESC";
...
$totalCobrado = array_sum(array_column($examenes, 'monto'));
$privados = count(array_filter($examenes, fn($e) => $e['tipo_paciente'] === 'Privado'));
$eps = count(array_filter($examenes, fn($e) => $e['tipo_paciente'] === 'EPS'));
?>
...
<head>
    ...
    <title>Reportes de Exámenes - Servimedic</title>
...
<body>
    <div class="container">
        <div class="page-header no-print">
            <div class="page-title-section">
                ...
                <h1 class="page-title">Reportes de Exámenes</h1>
            </div>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo $totalExamenes; ?></div>
            </div>
            <div class="stat-card">
            ...
            <div class="table-wrapper">
                <table id="reportTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $e['numero_ticket']; ?></td>
                            <td><?php echo date('d/m/Y H:i', strtotime($e['fecha_examen'])); ?></td>
                            <td><?php echo htmlspecialchars($e['nombre_paciente']); ?></td>
                            <td><?php echo $e['tipo_paciente']; ?></td>
                            <td><?php echo htmlspecialchars($e['examenes_realizados']); ?></td>
                            <td><?php echo $e['tipo_pago']; ?></td>
                            <td><?php echo $e['metodo_pago']; ?></td>
                            <td>Q<?php echo number_format($e['monto'], 2); ?></td>
                            <td><?php echo $e['sucursal_nombre']; ?></td>
                        </tr>
                        <?php endforeach; ?>
    ...
    <script>
        function exportToCSV() {
            ...
            a.href = url;
            a.download = 'reporte_examenes_<?php echo date("Y-m-d"); ?>.csv';
            a.click();
        }
    </script>
</body>
